    ...
    def chat(self, message: str, history: List[Tuple[str, str]]) -> str:
        ...
        try:
            ...
            if "429" in str(e) or "quota" in str(e).lower():
                return "⚠️ API quota exceeded. Using direct data access...\n\n" + self._try_direct_query(message, force=True)
...
with gr.Blocks(title="Amazon Smart Assistant", theme=gr.themes.Soft()) as demo:
    gr.Markdown(
        """
        # 🛒 Amazon Smart Assistant
        ...
        I can respond in natural language or provide SQL queries - just let me know your preference!
        """
    )
    ...
    gr.Markdown(
        ...
        - Want technical details? Just ask for "SQL format" or "show me the query"
        - I can analyze the data and provide insights in an easy-to-understand way
...
if __name__ == "__main__":
    ...
    print(f"🗃️  Dataset: {len(chatbot.df):,} products")
